...
public interface AnalysisCallback
{
	...
	* See xsbti.DependencyContext for the list of existing dependency contexts. */
	void classDependency(String dependsOn, String sourceClassName, DependencyContext context);
	...
	* <code>context</code> gives information about the context in which this dependency has been extracted.
	* See xsbti.DependencyContext for the list of existing dependency contexts. */
	void binaryDependency(File targetBinary, String targetProductName, String sourceClassName, File sourceFile, DependencyContext context);
